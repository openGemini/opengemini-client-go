...
type Client interface {
	...
	// WriteBatchLineProtocol write batch line protocol to assigned database.
	WriteBatchLineProtocol(ctx context.Context, database string, lineProtocol string) error
	// WriteBatchLineProtocolWithRp write batch line protocol to assigned database.retention_policy.
	WriteBatchLineProtocolWithRp(ctx context.Context, database string, rp string, lineProtocol string) error
